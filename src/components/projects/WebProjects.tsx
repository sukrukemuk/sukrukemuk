...
interface WebProjectsProps {
  onProjectSelect: (project: { name: string; type: 'web' }) => void;
}

export default function WebProjects({ onProjectSelect }: WebProjectsProps) {
  return (
      ...
      <div className="grid grid-cols-1 gap-4">
        {Object.entries(technologies.web).map(([projectName, techIcons]) => (
          ...
          >
            ...
            <button
              onClick={() => onProjectSelect({ name: projectName, type: 'web' })}
